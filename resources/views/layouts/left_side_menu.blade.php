    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="#sidebarBaseui" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <li>
                    <a href="#sidebarExtendedui" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <li>
                    <a href="#sidebarIcons" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <li>
                    <a href="#sidebarForms" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <li>
                    <a href="#sidebarCharts" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarMultilevel">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="#sidebarMultilevel3" data-bs-toggle="collapse" aria-expanded="false"
                                    aria-controls="sidebarMultilevel3">
