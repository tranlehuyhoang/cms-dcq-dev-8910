            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">{{ __('messages.skill_add_new') }}</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">{{ __('messages.skill_add_new') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="project_form" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ route('skill.update') }}">
                                ...
                                <input type="hidden" name="skill[id]" value="0">
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        <label class="form-label">{{ __('messages.name') }}</label>
                                        <input type="text" name="skill[name]" class="form-control" value="">
                                    </div>
                                </div>
