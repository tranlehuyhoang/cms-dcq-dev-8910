    ...
    <div class="content">
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="dropdown float-end">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <?php 
                                        if($value['id'] == $currentUser['id'] || $currentUser['role_id'] == 1){
                                            ?>
                            ...
                            <h4 class="mt-3 mb-1"><a href="{{ route('user.detail', $value['id']) }}"
                                    class="text-dark"><?php echo $value['name']; ?></a></h4>
                            <p class="text-muted">@Role <span> | </span> <span> <a
                                        href="{{ route('user.detail', $value['id']) }}"
            ...
            <div class="row mb-4">
                <div class="col-sm-6">
                    <div>
                        <h5 class="font-14 text-body">Showing Page <?php echo $currentPage; ?> Of <?php echo $numPage; ?></h5>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-end">
                        <ul class="pagination pagination-rounded mb-sm-0">
                            <li class="page-item <?php $currentPage == 1 ? 'disabled' : ''; ?> ">
                                <a href="{{ route('user.page', $currentPage - 1) }}" class="page-link"><i
                            ...
                            <?php 
                                    ...
                                    ?>
                            <li class="page-item">
                                <a href="{{ route('user.page', $i) }}" class="page-link"><?php echo $i; ?></a>
                            </li>
                            <?php
                                }
                            }
                            ?>
                            <li class="page-item <?php $currentPage == $numPage ? 'disabled' : ''; ?>">
                                <a href="{{ route('user.page', $currentPage + 1) }}" class="page-link"><i
